...
function install_dotnet {
    ...
    ./dotnet-install.sh --channel LTS  # Installiere die neueste LTS-Version von .NET SDK
...
function install_node {
    ...
    curl -fsSL https://deb.nodesource.com/setup_16.x | sudo -E bash -  # Installiere Node.js Version 16.x (LTS)
